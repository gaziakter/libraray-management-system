                ...
                <div class="card-body">
                    ...
                    <form action="" method="post" enctype="multipart/form-data">
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-sm-10">
                                <input name="student_name" type="text" class="form-control" value="{{$GetData->student_name}}">
                                @error('student_name')
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-sm-10">
                                <input name="father_name" type="text" class="form-control" value="{{$GetData->father_name}}">
                                @error('father_name')
                                <div class="text-danger">{{ $message }}</div>
                            @enderror
                            </div>
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-sm-10">
                                <input name="education_qualification" type="text" class="form-control" value="{{$GetData->education_qualification}}">
